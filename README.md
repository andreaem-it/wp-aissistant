...
| **Widget** | `sdk/widget/` | JavaScript ESM + esbuild | Il widget di chat, un artefatto solo per il plugin e per i siti non WordPress ([come si integra](docs/embedded-widget.md), [pacchetto](sdk/widget/README.md)) |
...
| `DATA_RETENTION_DAYS_AFTER_CANCEL` | `90` | Giorni in cui i dati di un tenant restano disponibili dopo la disdetta, prima di essere eliminati. Avvisi al cliente a 30/14/7/3 giorni dalla scadenza |
