 ...
 *
 * Espone `window.WPAI_RULES` nel browser e `module.exports` sotto Node.
 */
(function (root) {
  ...
  const api = { supportAvailable, proactiveMatches, proactiveAllowed, proactiveVariant, DAY_MS };

  if (typeof module !== "undefined" && module.exports) module.exports = api;
  else root.WPAI_RULES = api;
