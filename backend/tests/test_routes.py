...
def test_extracted_area_is_still_served():
    ...
    table = _table()
    expected = {**COMMERCIAL_ROUTES, **DEVELOPER_ROUTES, **PUBLIC_API_ROUTES, **CHANNEL_ROUTES, **INSIGHT_ROUTES}
...
def test_extracted_area_comes_from_the_router():
    ...
    from app.routers import channels, commercial, developers, insights, public_api
