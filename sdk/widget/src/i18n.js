 ...
 * più lunga del plugin, e le traduzioni cambiano con una cadenza diversa dal codice. Modulo ESM
 * del bundle `sdk/widget`: le stesse stringhe sono verificate dai test senza un DOM.
 *
...
export { DEFAULT, SUPPORTED, STRINGS, normalize, resolve, t };
