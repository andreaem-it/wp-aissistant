...
| Messaggi proattivi contestuali | **Rilasciata:** quattro trigger (URL, tempo sulla pagina, intento di uscita, carrello), frequenza configurabile, opt-out, A/B test con assegnazione stabile, metriche separate e vincitore suggerito solo oltre una soglia minima con confidenza statistica al 95%. | Prossimo passo: promozione manuale della variante vincente con un clic e storico degli esperimenti. | Media |
