...
| Integrazioni CRM | **Fondazione rilasciata:** configurazione HubSpot/Pipedrive per tenant senza segreti nel database, invio esplicito dei lead, retry idempotente e stato visibile nel panel. Restano adapter OAuth live, mapping campi e sincronizzazione automatica asincrona; poi Salesforce in base alla domanda. | Alta |
